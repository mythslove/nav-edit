...
package org.blch.findPath
{
	 ...
	 */
	public class NavMesh3 extends Sprite
	{
...
//							lastLineA.setPointB(lastPtA);
		...
		private function shortLine(l:Line2D):void{
			var v2f:Vector2f = l.getPointB().subtract(l.getPointA());
			var nf:Vector2f = v2f.normalize().mult(30);
			l.pointA = l.getPointA().add(nf);
			l.pointB = l.getPointB().subtract(nf);
		}
